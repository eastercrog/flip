...
export default function GameModeDropDown({
    gameMode,
    setGameMode
}) {
    const [gameModeSelect, setGameModeSelect] = useState(false)
    return ( <
            div className = 'dropDownContainer' > {!gameModeSelect &&
                <
                div className = 'gameModeDropDiv'
                onClick = {
                    () => {
                ...
                /div>} {
                    gameModeSelect && < div className = 'divider' > < /div>} {
                        gameModeSelect &&
                            ...
                            GAMEMODES <
                            /div> <
                            div className = 'singlePlayerSelect'
                        onClick = {
                                () => {
                                    setGameMode("coinflip");
