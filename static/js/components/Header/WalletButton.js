...
export const WalletButton = ({
    ...
    return ( <
        div className = "flex justify-between mx-5 w100" > {
            ...
            aria - hidden = "true" /
                ...
                FaChevronDown className = "-mr-1 ml-2"
            aria - hidden = "true" / >
                <
                /Menu.Button> <
                /div>
            ...
            leaveTo = "transform opacity-0 scale-95" >
                <
                Menu.Items className = "origin-top-right z-10 absolute right-0 mt-2 w-56 rounded-md shadow-lg bg-black text-white ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 focus:outline-none" >
                <
